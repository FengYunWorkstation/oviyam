...
public class SeriesComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
        ...
        if(sm1.getSeriesNumber() == null) {
            return(-1);
        } else if(sm2.getSeriesNumber() == null) {
            return(1);
        } else if(sm1.getSeriesNumber().indexOf("+") >= 0 || sm1.getSeriesNumber().indexOf("-") >= 0 || sm2.getSeriesNumber().indexOf("+") >= 0 || sm2.getSeriesNumber().indexOf("-") >= 0) {
